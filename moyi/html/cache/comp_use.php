...
<html>
	<head>
	    ...
	    <link href="<?php echo $this->ffwbms_vars["wset_ary"]['tpl_path'] ?>css/font-awesome.min.css" rel="stylesheet">
        <link rel="stylesheet" type="text/css" href="<?php echo $this->ffwbms_vars["wset_ary"]['tpl_path'] ?>css/use.css"/> 
	    ...
	    <script src="<?php echo $this->ffwbms_vars["wset_ary"]['tpl_path'] ?>js/use.js"></script>
	</head>
	<body>		
		<div class="demo" >
	<div class="row" style="margin-right: 0px;">
		...
		<div class="container">
			<div class="title wow">
				<?php $this->ffwbms_get_value(' ffa_sort_db ',' vte1 ', 'id = 22'); ?><!--获得指定分类号的数据-->
        		<?php $this->ffwbms_get_value(' ffa_art_value ',' vte1_art ', 'id = ' .$this->ffwbms_vars["vte1"][sart]); ?><!--获得指定文章号的文章数据    $vte1[sart]：返回分类所属文章号-->
				<p style="font-family: '微软雅黑';font-size: 22px; color: #000000;"><?php echo $this->ffwbms_vars["vte1"][sname] ?></p>
				<p style="font-size=14px;margin-top: 10px;"><?php echo $this->ffwbms_vars["vte1_art"][abs] ?></p>
			</div>
