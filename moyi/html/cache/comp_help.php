...
<html>
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $this->ffwbms_vars["wset_ary"]['tpl_path'] ?>css/help.css"/> 
	...
	<div class="row" style="margin-right: 0px;">
		...
		<div class="content">
			...
			<div class="content-text wow">
				<ul class="content-text-ul1 clearfix">
					<?php $this->ffwbms_get_value(' ffa_art_pglist ',' vtemp ', 'pid = ' .$this->ffwbms_vars["cur_uid"] .'|pg = ' .$this->ffwbms_vars["get_ary"]["pg"] .'|ps = 9|ob = 3'); ?>
					...
					<li class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
						<a href="?tpl=help-show&pid=<?php echo $this->ffwbms_vars["get_ary"]['pid'] ?>&uid=<?php echo $this->ffwbms_vars["get_ary"]['uid'] ?>&id=<?php echo $this->ffwbms_vars["ary"]['id'] ?>&sno=<?php echo $this->ffwbms_vars["get_ary"]['sno'] ?>&list=<?php echo $this->ffwbms_vars["get_ary"]['list'] ?>" style="text-decoration: none;">
    						<div class="content-text-list clearfix wow">
    							<div class="content-text-time col-xs-12 col-sm-4 col-md-4 col-lg-3">
    							   	<p class="content-text-time-p1"><?php echo $this->ffwbms_vars["ary"][stit] ?></p>
    							   	<p style="font-size: 10px;margin-top: 10px;"><?php echo $this->ffwbms_vars["ary"][keys] ?></p>
    							</div>
    							<div class="content-text-content col-xs-12 col-sm-8 col-md-8 col-lg-9">
    							   <p class="content-text-content-p1" style="color: #464646;font-size: 1pc;line-height: 20px;"><?php echo $this->ffwbms_vars["ary"][atit] ?></p>
    							   <br />
    							   <p style="line-height: 23px;font-size: 12px;"><?php echo $this->ffwbms_vars["ary"][abs] ?></p>
    							</div>
    						</div>
    					</a>
					</li>
	      		...
	      		<ul class="content-text-ul2 clearfix">
	      			<?php $this->ffwbms_get_value(' ffa_art_pglist ',' vtemp ', 'pid = ' .$this->ffwbms_vars["cur_uid"] .'|pg = ' .$this->ffwbms_vars["get_ary"]["pg"] .'|ps = 9|ob = 3'); ?>
	    			<!--{ffwbms ffa_art_astoplist,vte,'pid='.$cur_uid.'|ob=3'}--->
		            <?php foreach( $this->ffwbms_vars["vtemp"][0] as $this->ffwbms_vars["ary"]){ ?>
		            <?php $this->ffwbms_get_value(' ffa_art_value ',' arry ', 'id = ' .$this->ffwbms_vars["ary"][id]); ?>
					...
					<li class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
						<a href="?tpl=help-show&pid=<?php echo $this->ffwbms_vars["get_ary"]['pid'] ?>&uid=<?php echo $this->ffwbms_vars["get_ary"]['uid'] ?>&id=<?php echo $this->ffwbms_vars["ary"]['id'] ?>&sno=<?php echo $this->ffwbms_vars["get_ary"]['sno'] ?>&list=<?php echo $this->ffwbms_vars["get_ary"]['list'] ?>" style="text-decoration: none;">
    						<div class="content-text-list clearfix wow">
    							<div class="content-text-content col-xs-12 col-sm-12 col-md-12 col-lg-12">
    							   <p style="color: #464646;font-size: 1pc;line-height: 20px;"><?php echo $this->ffwbms_vars["ary"][atit] ?></p>
