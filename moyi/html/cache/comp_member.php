...
<html>
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $this->ffwbms_vars["wset_ary"]['tpl_path'] ?>css/member.css"/> 
	...
	<div class="row" style="margin-right: 0px;">
		...
		<div class="container">
			...
			<div class="title">
			    <p style="font-family: '微软雅黑'; font-size: 20px; color:#000000;"><?php echo $this->ffwbms_vars["ary_txt"][atit] ?></p>
			    <p ><?php echo $this->ffwbms_vars["ary_txt"][stit] ?></p>
		   </div>
		    <div class="content clearfix">
		    	<div class="content-left col-xs-12 col-sm-4 col-md-4 col-lg-4">
		    		<img src="<?php echo $this->ffwbms_vars["wset_ary"]['upload_path'] ?><?php echo $this->ffwbms_vars["ary_txt"][timgary][0][furl] ?>" >
		    	</div>
		    	<div class="content-right col-xs-12 col-sm-8 col-md-8 col-lg-8">
		    		<?php echo $this->ffwbms_vars["ary_txt"][atxt] ?>
		    	</div>
		    </div>		    
		</div>
		<!--页脚-->
