...
<html>
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $this->ffwbms_vars["wset_ary"]['tpl_path'] ?>css/help-show.css"/> 
	...
	<div class="row" style="margin-right: 0px;">
		...
		<div class="container">
			<div class="content clearfix">
				...
				<div class="content-left col-xs-12 col-sm-12 col-md-8 col-lg-8">
					<div class="title">
						<p style="font-size: 16px; color: #000000;"><?php echo $this->ffwbms_vars["ary_txt"][atit] ?></p>
						<p><?php echo $this->ffwbms_vars["ary_txt"][amdt] ?></p>
					</div>
					<div class="text">
						<p style="font-size: 14px;"><?php echo $this->ffwbms_vars["ary_txt"][atxt] ?></p>
					</div>
				</div>
				<div class="content-right col-xs-12 col-sm-12 col-md-4 col-lg-4">
					<div class="title">
						<p style="font-size: 15px; color: #000000;">相关内容</p>
					</div>
					<div class="text">
						<p>
						...
						<p style="border-top:1px dotted  #d3d3d3; margin-top:20px; margin-bottom:0px;"><br></p>
						<p style="font-size: 15px; color: #000000;"><?php echo $this->ffwbms_vars["ary_txt"][atit] ?></p>
						<p><?php echo $this->ffwbms_vars["ary_txt"][abs] ?></p>
						<p><?php echo $this->ffwbms_vars["ary_txt"][amdt] ?></p>
					</div>
				</div>
			</div>
