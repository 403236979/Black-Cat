...
<html>
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $this->ffwbms_vars["wset_ary"]['tpl_path'] ?>css/chanping.css"/> 
	...
	<div class="row" style="margin-right: 0px;">
		...
		<!--产品-->
		    ...
		    <div class="product wow">	
		    	...
		    	<div class="product-list">
		    		<ul style="margin: auto;overflow: hidden;">
		    			<?php $this->ffwbms_get_value(' ffa_art_pglist ',' vte ', 'pid = ' .$this->ffwbms_vars["cur_uid"] .'|pg = ' .$this->ffwbms_vars["get_ary"]["pg"] .'|ps = 6|ob = 2'); ?>
		    			<!--{ffwbms ffa_art_astoplist,vte,'pid='.$cur_uid.'|ob=3'}--->
			            <?php foreach( $this->ffwbms_vars["vte"][0] as $this->ffwbms_vars["ary"]){ ?>
			            <?php $this->ffwbms_get_value(' ffa_art_value ',' arry ', 'id = ' .$this->ffwbms_vars["ary"][id]); ?>
			            <!--{ffwbms_see $arry[timgary]}--->
		    ...
		    <!--页码-->
		    <?php if ($this->ffwbms_vars["vte"][0] != null){  ?>
			<div class="pagety-box">
				<p>
				    <?php $this->ffwbms_vars["pgg"] =$this->ffwbms_vars["vte"][1] ?>
				    <!---{ffwbms_see $pgg }-->
				    ...
				    <?php } ?>
				    <?php $this->ffwbms_vars["p"] = intval($this->ffwbms_vars["vte"][1][pages] , 10 ) ?>
				    ...
				    <a href="<?php echo $this->ffwbms_vars["vUrl"] ?>&pg=<?php echo $this->ffwbms_vars["vte"][1][pages] ?>"><img src="<?php echo $this->ffwbms_vars["wset_ary"]['tpl_path'] ?>images/pager.png" alt=""></a>
				    <?php } ?>
				</p>
			</div>
			<?php } ?>	
