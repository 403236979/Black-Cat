...
<title>在线管理后台 - 留言回复管理留言查看回复 - 登录用户用</title>
</head>
...
<div id="mainDiv">
	...
	<div id="right"> 
		<div id="current"><span style="float:right; margin-right:20px;"><a href="mess_user_list.php">返回留言列表</a></span>&nbsp;&nbsp;&nbsp;&nbsp;留言查看回复</div>
		<div id="form">
...
<form action="mess_user_list.php" method="post">

	<input name="act" type="hidden" value="mess_user_re" />
	<fieldset>
    <div class="ceng">
		<legend>留言</legend>
        ...
        <textarea name="info[re_mtxt]" cols="60" rows="8" id="re_mtxt"><?php echo $temp['relist'][0]['mtxt']; ?></textarea><br>
