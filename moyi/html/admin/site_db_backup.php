...
<![endif]–>
<title>在线管理后台- 备份恢复管理 - 网站数据备份</title>
</head>
...
<div id="mainDiv">
	...
	<div id="right"> 
		<div id="current">&nbsp;&nbsp;&nbsp;&nbsp;网站数据备份</div>
		<div id="form">
        <div class="add">
<div id="remess">网站备份中，不要关闭本页面，请稍侯......</div>
<?php
$wroot=$_SERVER["DOCUMENT_ROOT"]; //网站根
$sdir=$wroot; //来源目录
$datedir = "".date("Y").date("m").date("d").""; //日期目录名
$tdir=$wroot.'/backup'.'/'.$datedir; //目标目录
$aa=traversal_copy_dir($sdir.'/db',$tdir.'/db'); //echo $aa.'<br />';
$aa=traversal_copy_dir($sdir.'/upfiles',$tdir.'/upfiles'); //echo $aa.'<br />';
?>
<div id="remess">网站备份完成</div>
</div>
		</div>
		</div>
	</div>
