...
<![endif]–>
<title>在线管理后台 - 留言管理 - 留言分类管理 - 增加</title>
</head>
...
<div id="mainDiv">
	...
	<div id="right"> 
		<div id="current"><span style="float:right;"><a href="mess_sort_list.php" class="addStyle">返回留言分类列表</a></span>&nbsp;&nbsp;&nbsp;&nbsp;留言分类管理 - 增加</div>
		<div id="form">
<div class="add">
<form action="mess_sort_add.php" method="post">

	<input name="act" type="hidden" value="mess_sort_add" />
	<fieldset>
    <div class="ceng">
		<h3>留言分类</h3>

		<label for="sname">分类名:</label>
		<input name="info[sname]" type="text" id="sname" size="40" /><br />
        <table style="width:300px;">
<tr>
		<td><label for="sta1">状态1:</label></td>
		<td><input type="checkbox" value="1" id="staa" name="info[sta1]" />&nbsp;&nbsp;</td>
		<td><label for="sta2">状态2:</label></td>
		<td><input type="checkbox" value="1" id="stab" name="info[sta2]" />&nbsp;&nbsp;</td>
        </tr>
		<tr>
		<td><label for="sta3">状态3:</label></td>
		<td><input type="checkbox" value="1" id="stac" name="info[sta3]" />&nbsp;&nbsp;</td>
		<td><label for="sta4">状态4:</label></td>
		<td><input type="checkbox" value="1" id="stad" name="info[sta4]" />&nbsp;&nbsp;</td>
</table>
